...
kini_a1 ()
{
    ...
    int n;
    char da[13];
#ifdef TERMDA  /* dosn't work yet ***/
	fputs("P>|153|\\[c",stdout);
	fflush(stdout);
	read(fileno(stdin),da,12);
	da[5] = '\0';
	n = atoi(&da[3]);
	switch (n) {
	    case GURUXL:
...
ini1_a1 ()
{
    ...
    for(n=32; n<127; n++)
	    lexa1_s0[n] = n;    /* state 0 */
    lexa1_s0[127] = CCINT;
    for(n=32; n<128; n++)       /* state 1 - ctrl x */
	    lexa1_s1[n] = CCUNAS1;
}
...
#ifdef LMCHELP
/* tt_so      */    so_tcap,        /* (int (*) ()) 0, */
/* tt_soe     */    soe_tcap,       /* (int (*) ()) 0, */
/* tt_help    */    help_std,       /* (int (*) ()) 0, */
#endif LMCHELP
#ifdef LMCVBELL
/* tt_vbell   */    (int (*) ()) 0,
#endif LMCVBELL
...
"35;",                  /* zzDDM Del-Character Display mode (D,35)      */
"h",
"\033[>",               /* RM - Reset Mode                              */
...
static char *x_keysxl[] = {
    "P>",                 /*  XL DCS control.  */
    "|54;0;0;0;0|~J",       /* LINE FEED                            */
    "|73;0;0;0;0|~H",       /* BACK SPACE                           */
    "|74;0;0;0;0|~[[Z",     /* BACK TAB     - see CBT               */
    "|74;1;0;0;0|~[[Z",     /* BACK TAB     - see CBT               */
    "|95;0;0;0;0|~?",       /* DEL                                  */
    "|95;1;0;0;0|~?",       /* DEL                                  */
    "|95;2;2;1;0|~[e",      /* BREAK        - short break           */
    "|95;3;2;1;0|~[f",      /* BREAK        - long break            */
    "|106;1;0;2;0|~[[D",    /*              -See CUB                */
    "|108;1;0;2;0|~[[C",    /*              -See CUF                */
    "|112;1;0;2;0|~[[A",    /*              -See CUU                */
    "|117;1;0;1;0|~[[H",    /*              -See CUP                */
    "\033\134",             /* dc terminator           */
    0 } ;                   /* array terminator        */
#endif AAXL
