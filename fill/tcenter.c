...
/***/ printf ("Options and filterfiles done.\n");    

    if ( (opterrflg && !opt_stop_flg) || (badfileflg && !fil_stop_flg) ) {
/***/	printf ("Got flags opterrflg = %d, badfileflg = %d\n", opterrflg,
		badfileflg);
	curarg = 1;
	opterrflg = badfileflg = 0;
	show_errs_flg = 1;
...
/***/ printf ("Done second getoptions & filerfiles.\n");    
...
/***/	printf ("About to get options for realies.\n");
	getoptions(0);
...
/***/	printf ("About to filter first file for realies.\n");
	filterfiles(0);
