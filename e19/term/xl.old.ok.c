...
#define ISL     /* want ESC to still be <insmode> */
...
static char lexa1s0[128] = {
    ...
    CCINSMODE   , /* <cntr Z> */
#ifdef ISL
    CCINSMODE   , /* <escape> */  /* reserved for future use */
#else
    CCUNAS1     , /* <escape> */  /* reserved for future use */
#endif ISL
    CCINT       , /* <cntr \> */
    CCREPLACE   , /* <cntr ]> */
    CCERASE     , /* <cntr ^> */
