...
extern short    ospeed;         /* tty output baud rate */
...
#ifdef T_mac
# include "term/mac.c"
# define TM_mac &t_tcap
# define KB_mac &kb_mac
#else
# define TM_mac ((S_term *) 0)
# define KB_mac ((S_kbd *) 0)
#endif

#ifdef T_cue
#ifndef T_a1
#include "term/xl.c"    /* should maybe define required stuff in stds.c? */
#endif
#include "term/cue.c"
# define TM_cue &t_tcap
# define KB_cue &kb_cu
#else
# define TM_cue ((S_term *) 0)
# define KB_cue ((S_kbd *) 0)
#endif
