...
struct la_fpos {                /* used by la_ldelete */
    short            xla_fsline;/* which line of current fsd starting at 0 */
    short            xla_fsbyte;/* index into fsdbytes in current fsd */
    short            xla_lbyte; /* offset from beginning of current line */
    short            xla_ffpos; /* fsd fsdpos + this = offset in la_ffs */
 };
